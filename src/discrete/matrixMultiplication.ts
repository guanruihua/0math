 ...
 * @description 矩阵连乘
 * @param {MatrixConstant=[]} matrixMultiplier  矩阵乘数
 * @param {MatrixConstant=[]} matrixMultiplicand 被矩阵乘数
 */
export function matrixMultiplication(matrixMultiplier: MatrixConstant = [], matrixMultiplicand: MatrixConstant = []) {
  ...
  if (matrixMultiplierColSize !== matrixMultiplicandRowSize || matrixMultiplierRowSize !== matrixMultiplicandColSize) {
